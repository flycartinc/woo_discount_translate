...
<div id="wdrt-main">
    ...
    <div class="wdrt_content">
        <div class="wdrt-sections">
            <div class="title">
                <h3><?php _e('Loco Translate:', 'woo-discount-translate'); ?></h3>
            </div>
            <div class="content">
                <p><?php echo __('You can now translate the dynamic content like rules title, descriptions easily.', 'woo-discount-translate'); ?></p>
            </div>
        </div>
        <div class="wdrt-sections">
            <div class="title">
                <h3><?php _e('WPML Translate:', 'woo-discount-translate'); ?></h3>
            </div>
            <div class="content">
                <p><?php echo __('You can now translate the dynamic content like rules title, descriptions easily.', 'woo-discount-translate'); ?></p>
                <?php if (isset($is_wpml_translate_string_available) && $is_wpml_translate_string_available): ?>
                    <div class="wdrt_button">
                        ...
                        ><?php _e('Update Dynamic String for WPML', 'woo-discount-translate'); ?></a>
                    </div>
                <?php endif; ?>
            </div>
        </div>
